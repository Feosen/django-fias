# Generated by Django 4.1.7 on 2023-02-19 20:33
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shortname', models.CharField(blank=True, max_length=255, null=True, verbose_name='краткое наименование')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('objectid', models.BigIntegerField(primary_key=True, serialize=False, verbose_name='глобальный уникальный идентификатор объекта')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('objectid', fias.models.fields.BigIntegerRefField(to=[(fias.models.addr_obj.AddrObj, 'objectid')], verbose_name='глобальный уникальный идентификатор объекта')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('region', models.CharField(max_length=2, verbose_name='код региона')),
                ('isactive', models.BooleanField(verbose_name='статус активности')),
                ('objectid', fias.models.fields.BigIntegerRefField(to=[(fias.models.addr_obj.AddrObj, 'objectid'), (fias.models.house.House, 'objectid')], verbose_name='глобальный уникальный идентификатор объекта')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('objectid', models.BigIntegerField(primary_key=True, serialize=False, verbose_name='глобальный уникальный идентификатор объекта')),
                ('objectguid', models.UUIDField(verbose_name='глобальный уникальный идентификатор адресного объекта')),
                ('housenum', models.CharField(blank=True, max_length=20, null=True, verbose_name='номер дома')),
                ('addnum1', models.CharField(blank=True, max_length=20, null=True, verbose_name='дополнительный номер дома 1')),
                ('addnum2', models.CharField(blank=True, max_length=20, null=True, verbose_name='дополнительный номер дома 2')),
                ('housetype', models.IntegerField(verbose_name='основной тип дома')),
                ('addtype1', models.IntegerField(blank=True, null=True, verbose_name='дополнительный тип номера дома 1')),
                ('addtype2', models.IntegerField(blank=True, null=True, verbose_name='дополнительный тип номера дома 2')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('typeid', models.SmallIntegerField(verbose_name='тип')),
                ('value', models.CharField(max_length=250, verbose_name='значение')),
                ('objectid', fias.models.fields.BigIntegerRefField(to=[(fias.models.house.House, 'objectid')], verbose_name='глобальный уникальный идентификатор объекта')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('region', models.CharField(blank=True, max_length=2, null=True, verbose_name='регион')),
                ('table', models.CharField(max_length=15, verbose_name='таблица')),
                ('ver', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='fias.version', verbose_name='версия')),
            ],
        ),
        migrations.AddIndex(
            model_name='munhierarchy',
            index=models.Index(fields=['objectid', 'parentobjid'], name='fias_munhie_objecti_daa9b6_idx'),
        ),
        migrations.AddIndex(
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['objectid', 'parentobjid'], name='fias_admhie_objecti_a335ac_idx'),
        ),
        migrations.AddIndex(
