...
class SqlBuilder:
    ...
    @classmethod
    def insert(cls, dst: Type[Model], fields: Union[None, List[str]], values: Union[None, List[Any]],
               query: Union[None, str]) -> str:
    ...
    def update(cls, connection, dst: Type[Model], dst_pk: str, src: Type[Model], src_pk: str,
        ...
        return (f"UPDATE {dst._meta.db_table} SET {fields}"
    ...
    def delete_on_field(dst: Type[Model], dst_field: str, src: Type[Model], src_field: str) -> str:
        return (f"DELETE FROM {dst._meta.db_table}"
