...
class Migration(migrations.Migration):
    ...
    _operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "okato",
                    models.CharField(
                        blank=True, max_length=11, null=True, verbose_name="ОКАТО"
                    ),
                ),
                (
                    "oktmo",
                    models.CharField(
                        blank=True, max_length=11, null=True, verbose_name="ОКТМО"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "shortname",
                    models.TextField(
                        blank=True, null=True, verbose_name="краткое наименование"
                    ),
                ),
            ],
            options={
        ...
        migrations.AddIndex(
            model_name="house78",
            index=models.Index(
                fields=["objectid"], name="gar_house78_objecti_c911b3_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="house78",
            index=models.Index(
                fields=["objectguid"], name="gar_house78_objectg_7747b0_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="house78",
            index=models.Index(
                fields=["owner_adm"], name="gar_house78_owner_a_a33afd_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="house78",
            index=models.Index(
                fields=["owner_mun"], name="gar_house78_owner_m_318e68_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="house",
            index=models.Index(
                fields=["objectid"], name="gar_house_objecti_1911ad_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="house",
            index=models.Index(
                fields=["objectguid"], name="gar_house_objectg_a48da7_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="house",
            index=models.Index(
                fields=["owner_adm"], name="gar_house_owner_a_f74513_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="house",
            index=models.Index(
                fields=["owner_mun"], name="gar_house_owner_m_fb80bc_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="addrobj",
            index=models.Index(
                fields=["objectid"], name="gar_addrobj_objecti_ee18f2_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="addrobj",
            index=models.Index(
                fields=["objectguid"], name="gar_addrobj_objectg_d682c5_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="addrobj",
            index=models.Index(
                fields=["owner_adm"], name="gar_addrobj_owner_a_6877c5_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="addrobj",
            index=models.Index(
                fields=["owner_mun"], name="gar_addrobj_owner_m_3af51f_idx"
            ),
        ),
    ]
